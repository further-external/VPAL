...
<p>Fire this event when payment info has been completed (this may have to occur when the user returns form the Cybersource domain)</p>
<p>&nbsp;</p>
<p>Ecommerce Taxonomy:</p>
<table>
<tbody>
<tr>
<td>
...
<td>
<p><strong>ID for course list (if not available, pass name) -</strong> after click must be stored for other events</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p><strong>Name of course list (</strong>after click must be stored for other events)</p>
</td>
</tr>
<tr>
<td>
